<%-- 
    Document   : Partidos_Jugados
    Created on : 5 abr. 2024, 11:29:24
    Author     : jaime
--%>
...
<html>
    ...
    <body>
       ...
       <section>
       <%String nombre = (String) session.getAttribute("nombre_completo");%>
       <br><!-- comment -->
             ...
             <form action="" id="formEquipo" method="post" class="form-group text-center">
                    ...
                    <option value="" style="display:none;">Seleccionar Equipo</option>
                        <% Jugadores_Equipos equipoModelo = new Jugadores_Equipos();
                            List<Jugadores_EquiposDAO> equipos = equipoModelo.Mis_Equipos(nombre);
                    ...
                    <select id="selectTorneo" style=" font-size: 15px;" class="form-select text-center" name="torneoID">
                    ...
                    <br>
                    <br>
                    <button type="submit" style="font-size: 18px;" class="btn btn-primary">Mostrar Juegos</button>
             <br>
             <br>
        <div class="row">
            <div class="col">
        ...
        document.getElementById('formEquipo').addEventListener('submit', function(event) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        document.getElementById('tablaJuegos').innerHTML = xhr.responseText;
                    } else {
            ...
            xhr.open('POST', 'Partidos_Servlet', true);
