<%-- 
    Document   : Login_User
    Created on : 18 mar. 2024, 12:51:14
    Author     : jaime
--%>
      ...
      <form action="Validar_Credenciales" method="post">       
        <div class ="form-group text-center"> 
            ...
            <div style="width: 140px; height: 140px; border-radius: 50%; overflow: hidden;">
                <img src="Iconos/Jugador_2.jpg" hight="130" width="130" /> 
            </div>
            </div>
        </div>
        ...
        <div class ="form-group"> 
            ...
            <input class="form-control" style="font-size: 18px;" type="text" name="txtnombre" placeholder="Ingrese nombre de usuario" required> 
        </div>
            <br>    
        <div class ="form-group"> 
            <label class="h">
            <i class="fas fa-solid fa-lock"></i> Contraseña: </label>
            <input class ="form-control " style="font-size: 18px;" type="password" name="txtContrasena" placeholder="hasgdsf" required>     
        </div>
            <br>
            <div class="text-center">
            <input class="btn btn-primary btn-lg" style="font-size: 18px" type="submit" name="accion" value="Ingresar">
            <!--a href="Panel_Jugador.jsp">Ingresar</a-->
            </div>
            <br>
            <div style="background-color: cornsilk; border-radius: 10px;" class="text-center">
                <a href="Crear_Cuenta.jsp" style="color: #061b93; font-size: 16px;">Crear Cuenta</a>
            </div>
            <br><!-- comment --><!-- comment -->
